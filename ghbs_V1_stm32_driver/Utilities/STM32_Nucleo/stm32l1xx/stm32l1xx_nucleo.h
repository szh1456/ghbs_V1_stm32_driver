...
#define FORCE_SYNC_PIN             			 GPIO_Pin_10                  /* PA.10 */
...
/**
  * @brief  uni SPI Interface pins
  */
#define uni_SPI                          SPI1
#define uni_SPI_CLK                      RCC_APB2Periph_SPI1
   
#define uni_SPI_SCK_PIN                  GPIO_Pin_5                  /* PA.05 */
#define uni_SPI_SCK_GPIO_PORT            GPIOA                       /* GPIOA */
#define uni_SPI_SCK_GPIO_CLK             RCC_AHBPeriph_GPIOA
#define uni_SPI_SCK_SOURCE               GPIO_PinSource5
#define uni_SPI_SCK_AF                   GPIO_AF_SPI1

#define uni_SPI_MISO_PIN                 GPIO_Pin_6                 /* PA.06 */
#define uni_SPI_MISO_GPIO_PORT           GPIOA                       /* GPIOA */
#define uni_SPI_MISO_GPIO_CLK            RCC_AHBPeriph_GPIOA
#define uni_SPI_MISO_SOURCE              GPIO_PinSource6
#define uni_SPI_MISO_AF                  GPIO_AF_SPI1

#define uni_SPI_MOSI_PIN                 GPIO_Pin_7                 /* PA.07 */
#define uni_SPI_MOSI_GPIO_PORT           GPIOA                       /* GPIOA */
#define uni_SPI_MOSI_GPIO_CLK            RCC_AHBPeriph_GPIOA
#define uni_SPI_MOSI_SOURCE              GPIO_PinSource7
#define uni_SPI_MOSI_AF                  GPIO_AF_SPI1

#define uni_SPI_CS_PIN                 	 GPIO_Pin_6                  /* PB.06 */
#define uni_SPI_CS_GPIO_PORT             GPIOB                       /* GPIOB */
#define uni_SPI_CS_GPIO_CLK              RCC_AHBPeriph_GPIOB

#define uni_SPI_CS_PIN_AUX_A             GPIO_Pin_7                  /* PC.07 */
#define uni_SPI_CS_GPIO_PORT_AUX_A       GPIOC                       /* GPIOC */
#define uni_SPI_CS_GPIO_CLK_AUX_A        RCC_AHBPeriph_GPIOC

#define uni_SPI_CS_PIN_AUX_B             GPIO_Pin_9                  /* PA.09 */
#define uni_SPI_CS_GPIO_PORT_AUX_B       GPIOA                       /* GPIOA */
#define uni_SPI_CS_GPIO_CLK_AUX_B        RCC_AHBPeriph_GPIOA   

/**
  * @brief  adc SPI Interface pins
  */
#define adc_SPI                          SPI3
#define adc_SPI_CLK                      RCC_APB1Periph_SPI3
   
#define adc_SPI_SCK_PIN                  GPIO_Pin_10                  /* PC.10 */
#define adc_SPI_SCK_GPIO_PORT            GPIOC                       /* GPIOC */
#define adc_SPI_SCK_GPIO_CLK             RCC_AHBPeriph_GPIOC
#define adc_SPI_SCK_SOURCE               GPIO_PinSource10
#define adc_SPI_SCK_AF                   GPIO_AF_SPI3

#define adc_SPI_MISO_PIN                 GPIO_Pin_11                 /* PC.11 */
#define adc_SPI_MISO_GPIO_PORT           GPIOC                       /* GPIOC */
#define adc_SPI_MISO_GPIO_CLK            RCC_AHBPeriph_GPIOC
#define adc_SPI_MISO_SOURCE              GPIO_PinSource11
#define adc_SPI_MISO_AF                  GPIO_AF_SPI3

#define adc_SPI_MOSI_PIN                 GPIO_Pin_12                 /* PC.12 */
#define adc_SPI_MOSI_GPIO_PORT           GPIOC                       /* GPIOC */
#define adc_SPI_MOSI_GPIO_CLK            RCC_AHBPeriph_GPIOC
#define adc_SPI_MOSI_SOURCE              GPIO_PinSource12
#define adc_SPI_MOSI_AF                  GPIO_AF_SPI3

#define adc_SPI_CS_PIN_A                GPIO_Pin_2                  /* PB.02 */
#define adc_SPI_CS_GPIO_PORT_A          GPIOB                       /* GPIOB */
#define adc_SPI_CS_GPIO_CLK_A           RCC_AHBPeriph_GPIOB

#define adc_SPI_CS_PIN_B             		GPIO_Pin_11                  /* PB.11 */
#define adc_SPI_CS_GPIO_PORT_B       		GPIOB                       /* GPIOB */
#define adc_SPI_CS_GPIO_CLK_B        		RCC_AHBPeriph_GPIOB

#define adc_SPI_CS_PIN_C             		GPIO_Pin_12                  /* PB.12 */
#define adc_SPI_CS_GPIO_PORT_C       		GPIOB                       /* GPIOC */
#define adc_SPI_CS_GPIO_CLK_C       		RCC_AHBPeriph_GPIOB   

#define adc_SPI_CS_PIN_D                GPIO_Pin_8                  /* PC.08 */
#define adc_SPI_CS_GPIO_PORT_D          GPIOC                       /* GPIOC */
#define adc_SPI_CS_GPIO_CLK_D           RCC_AHBPeriph_GPIOC

#define adc_SPI_CS_PIN_E             		GPIO_Pin_6                  /* PC.06 */
#define adc_SPI_CS_GPIO_PORT_E       		GPIOC                       /* GPIOC */
#define adc_SPI_CS_GPIO_CLK_E        		RCC_AHBPeriph_GPIOC

#define adc_SPI_CS_PIN_F             		GPIO_Pin_5                  /* PC.05 */
#define adc_SPI_CS_GPIO_PORT_F       		GPIOC                       /* GPIOC */
#define adc_SPI_CS_GPIO_CLK_F       		RCC_AHBPeriph_GPIOC

#define adc_SPI_CS_PIN_G                GPIO_Pin_12                  /* PA.12 */
#define adc_SPI_CS_GPIO_PORT_G          GPIOA                       /* GPIOA */
#define adc_SPI_CS_GPIO_CLK_G           RCC_AHBPeriph_GPIOA

#define adc_SPI_CS_PIN_H             		GPIO_Pin_11                  /* PA.11 */
#define adc_SPI_CS_GPIO_PORT_H       		GPIOA                       /* GPIOA */
#define adc_SPI_CS_GPIO_CLK_H        		RCC_AHBPeriph_GPIOA


//#define fpga_FORCE_SYNC_N_PIN             		GPIO_Pin_0                  /* PC.0 */
//#define fpga_FORCE_SYNC_N_GPIO_PORT       		GPIOC                       /* GPIOC */
//#define fpga_FORCE_SYNC_N_GPIO_CLK        		RCC_AHBPeriph_GPIOC
